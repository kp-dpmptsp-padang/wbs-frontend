    ...
    <footer className="bg-white border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Logo and Description - WBS CLEAR */}
          <div className="col-span-1 md:col-span-1">
            <Logo variant="full" size="sm" isClickable={false} />
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="mt-4 text-sm text-gray-600">
              ...
              Mewujudkan pelayanan prima berbasis teknologi informasi.
            </p>
          </div>
          
          {/* Quick Links */}
          <div className="col-span-1">
            <h3 className="text-sm font-semibold text-gray-900 uppercase tracking-wider">Link Cepat</h3>
          ...
          {/* Contact */}
          <div className="col-span-1">
            <h3 className="text-sm font-semibold text-gray-900 uppercase tracking-wider">Hubungi Kami</h3>
            <ul className="mt-4 space-y-3">
              <li>
                <ContactItem icon={
                  ...
                  <a href="mailto:dmptsp@padang.go.id" className="text-gray-600 hover:text-primary">
                    dmptsp@padang.go.id
                  </a>
                </ContactItem>
              </li>
              <li>
                <ContactItem icon={
                  ...
                  <a href="tel:+6281374075085" className="text-gray-600 hover:text-primary">
                    0813-7407-5085
                  </a>
                </ContactItem>
              </li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <p className="text-center text-sm text-gray-500">
            &copy; {currentYear} DPMPTSP Kota Padang. Hak Cipta Dilindungi.
          </p>
        </div>
      </div>
    </footer>
...
const FooterLink = ({ to, children }) => {
  return (
    <li>
      <Link to={to} className="text-base text-gray-600 hover:text-primary transition-colors duration-150">
        {children}
      </Link>
    </li>
  );
